...
class Res2pix(object):
    ...
    def _setup_model(self):
        ...
        print("shape of binary_representations[0][0] = " + str(self._ops.binary_representations[0][0].get_shape()))
        self._ops.val_bitplane_summary = tf.summary.image("val_bitplane_img", self._ops.binary_representations[0][0,:,:,0])
