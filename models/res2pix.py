...
class Res2pix(object):
    ...
    def _setup_model(self):
        ...
        w, h, _ = self._ops.binary_representations[0][0].shape()
        print("shape of tf.reshape(self._ops.binary_representations[0][0,:,:,0], [1, w, h, 1]) = " + str(tf.reshape(self._ops.binary_representations[0][0,:,:,0], [1, w, h, 1]).shape()))
